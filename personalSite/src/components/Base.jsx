...
//                 <Button
//                     key={page.name}
//                     // When a link is clicked in the nav bar opens a new tab
//                     // Might not need this in future if i intend on keeping everything on the one page
//                     onClick={() => {
//                         if (page.external) {
...
const navItems = [
    ...
    { name: 'Projects', path: '#67' },
    { name: 'Weather App', path: 'https://weather.heather.network/', external: true },
    { name: 'Other', path: '/temp' }
];
